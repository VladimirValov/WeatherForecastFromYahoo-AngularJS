...
angular.
  ...
  component('weatherForecast', {
   ...
   this.channel = this.api.query.results.channel;

   this.location = this.channel.location;
   this.currentCity = this.location.city;

   this.forecast = this.channel.item.forecast;
   this.lastBuildDate = this.channel.lastBuildDate;

   this.currentWeather = this.channel.item.condition;
   this.wind = this.channel.wind;
   this.atmosphere = this.channel.atmosphere;
   this.astronomy = this.channel.astronomy;
